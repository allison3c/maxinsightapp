...
{
    public class ECalendarViewRenderer : ViewRenderer<ECalendarView, RelativeLayout>
    {
        /// <summary>
        ///     The tag
        /// </summary>
        ...
        ///     The _picker
        /// </summary>
        private ECalendarPickerView _picker;
        ...
        {
            if (newMonth >= ECalendarView.FirstDayOfMonth(Element.MinDate) &&
                newMonth <= ECalendarView.LastDayOfMonth(Element.MaxDate))
            {
