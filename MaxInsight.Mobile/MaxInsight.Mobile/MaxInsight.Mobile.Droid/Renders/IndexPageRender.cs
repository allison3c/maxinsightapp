...
[assembly: ExportRenderer(typeof(IndexPage), typeof(IndexPageRender))]
namespace MaxInsight.Mobile.Droid.Renders
{
    internal class IndexPageRender : VisualElementRenderer<IndexPage>, IOnTabClickListener
    {
        ...
        protected override void OnLayout(bool changed, int l, int t, int r, int b)
        {
            ...
            //barHeight = barHeight + (int)(barHeight / 2.3);
        ...
        private void InitializeElement(IndexPage element)
        {
            PopulateChildren(element);
        }

        private void PopulateChildren(IndexPage element)
        {
        ...
        private void ClearElement(IndexPage element)
        {
            if (_currentPage != null)
            {
