...
{
    public class ECalendarPickerView : ViewPager
    {
        /// <summary>
        /// Enum SelectionMode
        /// </summary>
        ...
        /// My adapter
        /// </summary>
        internal readonly EMonthAdapter MyAdapter;
        /// <summary>
        /// The months
        /// </summary>
        ...
        {
            foreach (var item in _highlightedCells)
            {
    ...
    public class EFluentInitializer
    {
        /// <summary>
        /// The _calendar
        /// </summary>
        private readonly ECalendarPickerView _calendar;
        ...
        /// <returns>FluentInitializer.</returns>
        public EFluentInitializer InMode(ECalendarPickerView.SelectionMode mode)
        {
            _calendar.Mode = mode;
        ...
        /// <param name="selectedDate">The selected date.</param>
        /// <returns>FluentInitializer.</returns>
        public EFluentInitializer WithSelectedDate(DateTime selectedDate)
        {
        ...
        public EFluentInitializer WithLocale(Java.Util.Locale locale)
        {
        ...
        /// <param name="date">The date.</param>
        /// <returns>FluentInitializer.</returns>
        public EFluentInitializer WithHighlightedDate(DateTime date)
        {
