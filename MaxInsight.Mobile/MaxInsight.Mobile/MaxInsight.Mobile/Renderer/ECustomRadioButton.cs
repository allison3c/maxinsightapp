...
{
    public class ECustomRadioButton : View
    {
        /// <summary>
        /// The checked property
        /// </summary>
        public static readonly BindableProperty CheckedProperty =
            BindableProperty.Create<ECustomRadioButton, bool>(
                p => p.Checked, false);
        ...
        public static readonly BindableProperty TextProperty =
            BindableProperty.Create<ECustomRadioButton, string>(
        ...
        public static readonly BindableProperty TextColorProperty =
            BindableProperty.Create<ECustomRadioButton, Color>(
