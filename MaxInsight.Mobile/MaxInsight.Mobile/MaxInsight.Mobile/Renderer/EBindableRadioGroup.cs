...
{
    public class EBindableRadioGroup : StackLayout
    {
        /// <summary>
        /// The items
        /// </summary>
        public ObservableCollection<ECustomRadioButton> Items;

        /// <summary>
        /// Initializes a new instance of the <see cref="EBindableRadioGroup"/> class.
        /// </summary>
        public EBindableRadioGroup()
        {
            Items = new ObservableCollection<ECustomRadioButton>();
        }
        ...
        public static BindableProperty ItemsSourceProperty =
                    BindableProperty.Create<EBindableRadioGroup, IEnumerable>(o => o.ItemsSource, default(IEnumerable), propertyChanged: OnItemsSourceChanged);

        /// <summary>
        /// The selected index property
        /// </summary>
        public static BindableProperty SelectedIndexProperty =
            BindableProperty.Create<EBindableRadioGroup, int>(o => o.SelectedIndex, default(int), BindingMode.TwoWay,
        ...
        private void OnCheckedChanged(object sender, EventArgs<bool> e)
        {
            ...
            var selectedItem = sender as ECustomRadioButton;
        ...
        private static void OnSelectedIndexChanged(BindableObject bindable, int oldvalue, int newvalue)
        {
            ...
            var bindableRadioGroup = bindable as EBindableRadioGroup;
        ...
        {
            var radButtons = bindable as EBindableRadioGroup;
            ...
            {
                var button = new ECustomRadioButton
                {
                    Text = item.ToString(),
                    Id = radIndex++,
