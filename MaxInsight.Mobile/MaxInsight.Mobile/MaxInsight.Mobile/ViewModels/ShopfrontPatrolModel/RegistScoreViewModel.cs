...
{
    public class RegistScoreViewModel : ViewModel
    {
        ...
        private async void SaveRegistCore()
        {
            try
            {
                ...
                foreach (var item in SystemList)
                {
                    ...
                    scoreDto.PlanApproalYN = item.PlanApproalYN;
                    scoreDto.ResultApproalYN = item.ResultApproalYN;
                    scoreDto.PlanFinishDate = item.PlanFinishDate;
                    scoreDto.ResultFinishDate = item.ResultFinishDate;
                    int score;
                    if (int.TryParse(CurrentScore, out score))
                    {
