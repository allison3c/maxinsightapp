...
namespace MaxInsight.Mobile.iOS.Renderer
{
    ...
    /// Class MonthGridView.
    /// </summary>
    public class EMonthGridView : UIView
    {
        /// <summary>
        /// The _calendar month view
        /// </summary>
        private readonly ECalendarMonthView _calendarMonthView;
        ...
        /// The day tiles
        /// </summary>
        protected readonly IList<ECalendarDayView> DayTiles = new List<ECalendarDayView>();
        /// <summary>
        ...
        protected ECalendarDayView SelectedDayView { get; set; }
        /// <summary>
        ...
        public EMonthGridView(ECalendarMonthView calendarMonthView, DateTime month)
        {
