...
[assembly: ExportRenderer(typeof(ECustomRadioButton), typeof(ERadioButtonRenderer))]
namespace MaxInsight.Mobile.iOS.Renderer
{
    public class ERadioButtonRenderer : ViewRenderer<ECustomRadioButton, ERadioButtonView>
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<ECustomRadioButton> e)
        {
            base.OnElementChanged(e);

            if (Control == null)
            {
                var checkBox = new ERadioButtonView(Bounds);
