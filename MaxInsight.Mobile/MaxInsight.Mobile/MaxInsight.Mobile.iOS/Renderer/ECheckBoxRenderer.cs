...
[assembly: ExportRenderer(typeof(ECheckBox), typeof(ECheckBoxRenderer))]
namespace MaxInsight.Mobile.iOS.Renderer
{
    public class ECheckBoxRenderer : ViewRenderer<ECheckBox, CheckBoxView>
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<ECheckBox> e)
        {
