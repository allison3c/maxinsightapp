...
namespace MaxInsight.Mobile.iOS.Renderer
{
    ...
    /// </summary>
    public class ECalendarDayView : UIView
    {
        /// <summary>
        /// The paragraph style
        /// </summary>
        ...
        public override void Draw(CGRect rect)
        {
            ...
            var backgroundStyle = ECalendarView.BackgroundStyle.Fill;
            ...
            {
                if (backgroundStyle == ECalendarView.BackgroundStyle.Fill)
                {
                ...
                else
                {
                    ...
                    if (backgroundStyle == ECalendarView.BackgroundStyle.CircleFill)
                    {
                        context.SetFillColor(BackgroundColor.CGColor);
