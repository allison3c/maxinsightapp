...
{
    /// <summary>
    /// Class ERadioButtonView.
    /// </summary>
    [Register("ERadioButtonView")]
    public class ERadioButtonView : UIButton
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ERadioButtonView"/> class.
        /// </summary>
        public ERadioButtonView()
        {
            Initialize();
        }
        ...
        public ERadioButtonView(CGRect bounds)
            : base(bounds)
        {
            Initialize();
        }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ERadioButtonView"/> is checked.
        /// </summary>
