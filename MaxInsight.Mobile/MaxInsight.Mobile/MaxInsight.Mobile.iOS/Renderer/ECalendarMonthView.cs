...
namespace MaxInsight.Mobile.iOS.Renderer
{
    /// <summary>
    ...
    /// </summary>
    public class ECalendarMonthView : UIView
    {
        ...
        /// </summary>
        private EMonthGridView _monthGridView;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ECalendarMonthView"/> class.
        /// </summary>
		...
		public ECalendarMonthView(DateTime selectedDate, bool showHeader, bool showNavArrows, float width = 320)
        {
            ...
            StyleDescriptor = new EStyleDescriptor();
			...
			width = float.Parse(UIScreen.MainScreen.Bounds.Width.ToString());
		...
		public ICollection<DateTime> HighlightedDays { get; private set; }
        /// <summary>
        ...
        public EStyleDescriptor StyleDescriptor { get; private set; }
        ...
        public override void Draw(CGRect rect)
        {
            using (var context = UIGraphics.GetCurrentContext())
            {
				...
				context.FillRect(new CGRect(0, 0, _width, 18 + _headerHeight));
            }
        ...
        public override void LayoutSubviews()
        {
            ...
            {
				ContentSize = new CGSize(_width, 260),
                ScrollEnabled = false,
				Frame = new CGRect(0, 16 + _headerHeight, _width, Frame.Height - 16),
        ...
        private EMonthGridView CreateNewGrid(DateTime date)
        {
            var grid = new EMonthGridView(this, date) { CurrentDate = CurrentDate };
            grid.BuildGrid();
			grid.Frame = new CGRect(0, 0, _width, Frame.Height - 16);
            return grid;
        }
        ...
        {
			var r = new CGRect(new CGPoint(0, 2), new CGSize { Width = _width, Height = _headerHeight });
