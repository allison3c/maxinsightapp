...
using MaxInsight.Mobile.iOS.Renderer;
using System;
using Xamarin.Forms;
using Xamarin.Forms.Platform.iOS;

[assembly: ExportRenderer(typeof(ECalendarView), typeof(ECalendarViewRenderer))]
namespace MaxInsight.Mobile.iOS.Renderer
{
    public class ECalendarViewRenderer : ViewRenderer<ECalendarView, ECalendarMonthView>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ECalendarViewRenderer"/> class.
        /// </summary>
        public ECalendarViewRenderer()
        {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<ECalendarView> e)
        {
            ...
            if (Control == null)
            {
                var calendarView = new ECalendarMonthView(DateTime.MinValue, true, e.NewElement.ShowNavigationArrows);
        ...
        protected override void OnElementPropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            ...
            ProtectFromEventCycle(() =>
            {
                ...
                else if (e.PropertyName == ECalendarView.SelectedDateProperty.PropertyName)
                {
                ...
                else if (e.PropertyName == ECalendarView.MinDateProperty.PropertyName)
                {
                    this.Control.SetMinAllowedDate(this.Element.MinDate);
                }
                else if (e.PropertyName == ECalendarView.MaxDateProperty.PropertyName)
                {
                    this.Control.SetMaxAllowedDate(this.Element.MaxDate);
				}else if (e.PropertyName == ECalendarView.HighlightedDaysProperty.PropertyName)
				{
					this.Control.HighlightDates(this.Element.HighlightedDays);
					this.Control.SetDisplayedMonthYear(this.Element.DisplayedMonth, false);
				}
			});
