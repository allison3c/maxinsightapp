...
namespace MaxInsight.Mobile.iOS.Renderer
{
    public class EStyleDescriptor
    {
        ...
        /// </summary>
        public UIColor TodayForegroundColor = Color.FromHex("#ff778088").ToUIColor();
                                                          /// <summary>
                                                          /// The today background color
                                                          /// </summary>
        public UIColor TodayBackgroundColor = Color.FromHex("#ccffcc").ToUIColor();
                                                               /// <summary>
        ...
        /// </summary>
        public UIColor HighlightedDateBackgroundColor = Color.FromHex("#ff0000").ToUIColor();
        /// <summary>
        ...
        /// </summary>
        public ECalendarView.BackgroundStyle SelectionBackgroundStyle = ECalendarView.BackgroundStyle.Fill;
        /// <summary>
        /// The today background style
        /// </summary>
        public ECalendarView.BackgroundStyle TodayBackgroundStyle = ECalendarView.BackgroundStyle.Fill;
        /// <summary>
        /// The date label font
        /// </summary>
        public UIFont DateLabelFont = UIFont.BoldSystemFontOfSize(12);
        /// <summary>
